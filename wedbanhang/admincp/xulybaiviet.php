...
if(isset($_POST['thembaiviet'])){
    $sql_them ="INSERT INTO tbl_baiviet(tenbaiviet,hinhanh,tomtat,noidung,tinhtrang,id_danhmucbaiviet) 
    VALUES('".$tenbaiviet."','".$hinhanh."','".$tomtat."','".$noidung."','".$tinhtrang."','".$danhmuc."')";
    mysqli_query($mysqli,$sql_them);
    move_uploaded_file($hinhanh_tmp,'uploadsbaiviet/'.$hinhanh);
    ...
    if(!empty($_FILES['hinhanh']['name'])){
        ...
        while($row = mysqli_fetch_array($query)){
            unlink('uploadsbaiviet/'.$row['hinhanh']);
        }  
        $sql_sua ="UPDATE tbl_baiviet SET tenbaiviet='".$tenbaiviet."',
        hinhanh='".$hinhanh."',tomtat='".$tomtat."',noidung='".$noidung."',
        tinhtrang='".$tinhtrang."',id_danhmucbaiviet='".$danhmuc."'
