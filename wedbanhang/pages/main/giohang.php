...
<table style="width:100%; text-align:center;border-collapse:collapse;" border="1">
 ...
 ?>
  <tr>
    ...
    <td><img src ="../admincp/uploads/<?php echo $cart_item['hinhanh']; ?>" width="100px" ></td>
    <td>
  ...
  <?php
    ...
    ?>
    <tr>
        <td colspan="8" ><p style="color: red;font-weight: bold;font-size: 20px;width: 30%;margin-left: 400px;;float: left;"> TỔNG TIỀN: <?php echo number_format($tongtien,0,',','.').' VND' ?></p><br/>
